...
class XTLoss(nn.Module):
    ...
    def forward(self, left_img, right_img, dispmap_left, dispmap_right, dispmap_gt, weight):
        ...
        # """ Occluded pixels
        # occluded pixels mean you want to distinguish disparity estimations that are smaller than 1 (to reduce the noise ot the network)
        # so allmost every pixel in the start is occluded!!!
        # this is some kinds on an invalidation network!!!
